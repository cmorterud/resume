...
\begin{itemize}  \itemsep -2pt %reduce space between items
    ...
    \item Validate and conduct production releases for stakeholders independently and safely with no downtime.
...
\bigskip
\begin{parcolumns}[rulebetween,colwidths={}]{6}
    \colchunk[1]{\textbf{Languages}\\Java\\C/C\texttt{++}\\JavaScript\\C\texttt{\#} .NET\\Python\\\LaTeX}
    \colchunk[2]{\textbf{IDE}\\IntelliJ\\Visual Studio\\VIM}
    \colchunk[3]{\textbf{Technologies}\\Git\\Bash\\Jenkins\\Splunk\\Kibana\\Grafana}
    \colchunk[4]{\\Postman\\Cucumber\\Perf\\MapReduce\\Flask}
    \colchunk[5]{\\WPF\\GDB\\Valgrind\\Make\\PyTorch}
    \colchunk[5]{\textbf{Java}\\Spring\\Maven\\Mockito}
    \colchunk[6]{\textbf{AWS}\\EC2\\ECS\\RDS\\ALB\\CloudWatch\\Lambda}
\end{parcolumns}

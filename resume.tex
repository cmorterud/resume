...
\begin{itemize}  \itemsep -2pt %reduce space between items
    ...
    \item Validate and conduct production releases independently and safely with no downtime.
    ...
    % \item Manage compliance requirements to ensure security of platform.
...
\begin{parcolumns}[rulebetween,colwidths={}]{6}
    ...
    \colchunk[3]{\textbf{Technologies}\\Git\\Bash\\Jenkins\\Kibana\\Grafana}
    ...
    \colchunk[6]{\textbf{AWS}\\CloudWatch\\Lambda\\ECS\\RDS\\ALB}
\end{parcolumns}

...
\begin{parcolumns}[rulebetween,distance=2em,nofirstindent=true]{5}
    ...
    \colchunk[2]{\textbf{Technologies}\\Git\\Bash\\Splunk\\Kibana\\GDB\\Valgrind}
    \colchunk[3]{\\Postman\\Cucumber\\Perf\\Flask}
    % \colchunk[5]{\\GDB\\Valgrind}
    \colchunk[4]{\textbf{Java}\\Spring Boot\\Maven\\Mockito}
    \colchunk[5]{\textbf{AWS CSAA 12/2019}\\EC2\\ECS\\RDS\\ALB\\CloudWatch\\Lambda}
\end{parcolumns}

...
\begin{parcolumns}[rulebetween,colwidths={5=2cm,1=2cm}]{6}
    ...
    \colchunk[3]{\textbf{Technologies}\\Git\\Bash\\Kibana\\Grafana\\Maven}
    \colchunk[4]{\\Mockito\\Java Spring\\AWS Lambda\\AWS ECS\\AWS RDS}
    \colchunk[5]{\\AWS CloudWatch\\Flask\\Perf\\MapReduce\\Postman}

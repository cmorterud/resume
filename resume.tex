...
\begin{itemize}  \itemsep -2pt %reduce space between items
    \item Moderate Java Spring Boot platform contributions to ensure production stability and feature delivery on-time.
    ...
    \item Inner sourced platform, insituting code quality standards and requirements for features.
...
\begin{parcolumns}[rulebetween,distance=2em,nofirstindent=true]{5}
    \colchunk[1]{\textbf{Languages}\\C/C\texttt{++}\\Java\\Python\\C\texttt{\#} .NET\\JavaScript\\\LaTeX}
